...
lifecycles.
Reversible production groundwork now extracts the existing Yard Owner four-step
...
adds explicit retry/access review and Home exits while withholding stale or
