...
- Maintain the active Raspberry Pi development deploy with its validated ARM64
  image, tailnet-only HTTPS, PostgreSQL readiness, and application rollback;
  keep the Render/Cognito pilot gate separate.
