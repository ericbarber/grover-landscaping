...
| All-persona minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md), [all-persona plan](../design/review/all-persona-minimal-rollout-plan.md), [owner plan](../design/review/yard-owner-minimal-rollout-plan.md), and [crew plan](../design/review/crew-lead-minimal-rollout-plan.md) | Partial; repository control plane and composition adopted | Thirty-six cumulative units cover all ten signed-in persona designs. Exact-scope cohorts, immutable lifecycle audit, guarded owner/support operations, managed navigation, and contextual Yard Owner, manager, field, and Property Manager composition are delivered for authoritative roles. The protected per-unit runner is ready, but hosted execution, operational enablement, and explicit Dispatcher/Billing backend roles remain. |
