...
repository-owned slice, but persistence is paused on its explicit mobilization/
work-release source decision. Repository maintenance and regression remain ongoing.
