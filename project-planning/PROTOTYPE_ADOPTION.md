...
| Yard Owner portal | [Working portal](../design/prototypes/yard-owner-portal/README.md) and [V2 handoff](../design/review/yard-owner-portal-v2-handoff.md) | Partial · persisted Home/Visits adopted | Home, Visits, Proof, and Account plus property context and delivered proof are adopted. Home/Visits now use the minimized authorized persisted read with explicit recovery and no illustrative fallback. The mobilization/work-release source decision is accepted; implement it before customer-safe service-day states, concern recovery, recommendation collaboration, and preferences. Billing remains product-gated. |
...
is accepted and persistence is next. Repository maintenance and regression
remain ongoing.
