...
| --- | --- | --- | --- |
| Minimalist persona experiences | [Task-first working prototype](../design/prototypes/minimalist-personas/README.md) and [persona journey plan](../design/review/minimalist-persona-prototype-plan.md) | Validated design direction | Ten personas have distinct first answers, primary actions, compact navigation, short queues, explicit omissions, progressive detail, and three responsive scenarios. Conduct human workflow/content review, then adopt approved customer, field, operations, and administrative patterns in bounded slices without widening capability or role contracts. |
