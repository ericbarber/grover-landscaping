...
| Yard Owner and Crew Lead minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md), [owner plan](../design/review/yard-owner-minimal-rollout-plan.md), and [crew plan](../design/review/crew-lead-minimal-rollout-plan.md) | Design ready; capability control not implemented | Yard Owner U1–U4 stage care, visits, proof, and contextual writes. Crew Lead C1–C4 stage day-plan visibility, stop execution, field proof, and changes/recovery. Implement server-derived account/crew capabilities, audited cohorts, protected unit smoke, offline recovery, and rollback before live enablement. |
