...
| All-persona minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md), [all-persona plan](../design/review/all-persona-minimal-rollout-plan.md), [owner plan](../design/review/yard-owner-minimal-rollout-plan.md), and [crew plan](../design/review/crew-lead-minimal-rollout-plan.md) | Design ready; capability control not implemented | Thirty-six cumulative units cover all ten signed-in production personas with role/tool boundaries, minimum useful releases, dependencies, and rollback. Implement the shared server-derived capability projection, audited cohorts, protected per-unit smoke, operational ownership, and persona-specific recovery before live enablement. |
