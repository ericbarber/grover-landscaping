...
| Manager daily operations | [Schedule V1](../design/high-fidelity/manager/schedule-desktop-v1.png) and [manager wireframes](../design/wireframes/manager/00-manager-hub.svg) | Partial | Authenticated Schedule adopts Today’s operation metrics, compact target controls, desktop route board + planning inspector, and responsive stacking while preserving existing contracts. Next converge capacity/publish states and Recovery with return context. |
