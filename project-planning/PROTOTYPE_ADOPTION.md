...
| Completion proof and communication | [Reports wireframe](../design/wireframes/manager/04-reports.svg) and [shared proof wireframe](../design/wireframes/public/04-shared-customer-proof.svg) | Partial | Manager Reports adopts the branded responsive review board and opens the exact Job Report workflow. Shared proof adopts service identity, immutable evidence, completed add-ons, retry recovery, and an explicit customer-safe trust boundary. Next converge recommendation/add-on and bid decisions. |
