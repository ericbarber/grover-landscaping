...
| Yard Owner minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md) and [rollout plan](../design/review/yard-owner-minimal-rollout-plan.md) | Design ready; capability control not implemented | U1 launches Home as a complete read-only care view; U2 adds Visits, U3 adds Proof, and U4 adds contextual questions/decisions. Implement server-derived account capabilities, audited cohort control, protected unit smoke, and rollback before live enablement. |
