...
| All-persona minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md), [all-persona plan](../design/review/all-persona-minimal-rollout-plan.md), [owner plan](../design/review/yard-owner-minimal-rollout-plan.md), and [crew plan](../design/review/crew-lead-minimal-rollout-plan.md) | Partial; default-off read projection delivered | Thirty-six cumulative units cover all ten signed-in persona designs. `/me/access` now returns server-derived current-role/scope capability maps with all product units off; audited cohort persistence, enable/suspend control, navigation shaping, protected smoke, and explicit Dispatcher/Billing backend roles remain before live enablement. |
