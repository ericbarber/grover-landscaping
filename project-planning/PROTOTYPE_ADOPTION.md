...
| --- | --- | --- | --- |
| Minimalist persona experiences | [Task-first working prototype](../design/prototypes/minimalist-personas/README.md), [persona journey plan](../design/review/minimalist-persona-prototype-plan.md), and [minimal-product workflow](../design/review/minimal-product-user-workflow.md) | Validated broad design direction; minimal-product workflow discovery active | Ten personas retain future design evidence, but Dispatcher and Crew Member are explicitly deferred from the minimum product. Company Manager owns planning and Crew Lead owns field delivery in the proposed core loop. Complete evidence-led workflow discovery before revising prototypes or beginning bounded production adoption. |
