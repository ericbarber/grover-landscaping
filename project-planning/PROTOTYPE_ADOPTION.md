...
| --- | --- | --- | --- |
| Simplified product experience | [Active post-MVP plan](../design/review/simplified-product-experience-plan.md), [broad persona prototype](../design/prototypes/minimalist-personas/README.md), and [retained research kit](../design/review/minimal-product-workflow-session-guide.md) | SX0 design direction delivered; clean-slate prototype next | Mature capability will be reorganized around one role-filtered service thread rather than reduced to an MVP. Build and validate Yard Owner, Company Manager, and Crew Lead first; retain other persona work as broader evidence and begin production adoption only after comparative workflow review. |
