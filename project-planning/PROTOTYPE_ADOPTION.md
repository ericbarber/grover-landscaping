...
| --- | --- | --- | --- |
| Simplified product experience | [Active service-thread prototype](../design/prototypes/simplified-service-thread/README.md), [post-MVP plan](../design/review/simplified-product-experience-plan.md), and [retained research kit](../design/review/minimal-product-workflow-session-guide.md) | SX3 validated design direction; production adoption not started | Five core perspectives follow one exact service through decision, release, field work/recovery, and proof. Seven contextual paths cover plan conflict, offline work, proof correction, minimized Support, product-gated completion readiness, ended access, and authorization mismatch. Run comparative workflow review before defining React adoption. |
