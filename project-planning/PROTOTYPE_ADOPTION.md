...
| Crew field route and execution | [Crew route V1](../design/high-fidelity/field/crew-route-mobile-v1.png) and [field wireframes](../design/wireframes/field/01-home.svg) | Partial | Route adopts progress → Current stop → Up next hierarchy; Jobs adopts compact ordered cards, readiness, search, and status filters. Converge Job overview/checklist/photos/add-ons/report while retaining durable offline and conflict behavior. |
