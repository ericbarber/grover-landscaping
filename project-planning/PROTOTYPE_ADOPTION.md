...
| --- | --- | --- | --- |
| Simplified product experience | [Active service-thread prototype](../design/prototypes/simplified-service-thread/README.md), [post-MVP plan](../design/review/simplified-product-experience-plan.md), and [retained research kit](../design/review/minimal-product-workflow-session-guide.md) | SX1 validated design direction; production adoption not started | Yard Owner, Company Manager, and Crew Lead now follow one exact service through decision, release, field work/recovery, and proof with role-filtered content. Extend Company Owner and Property Manager next; retain other persona work as broader evidence and begin production adoption only after comparative workflow review. |
