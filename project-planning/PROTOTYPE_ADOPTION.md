...
| --- | --- | --- | --- |
| Minimalist persona experiences | [Task-first working prototype](../design/prototypes/minimalist-personas/README.md) and [persona journey plan](../design/review/minimalist-persona-prototype-plan.md) | Validated design direction; customer and field journeys connected | Ten personas have distinct first answers, primary actions, compact navigation, short queues, explicit omissions, progressive detail, and three responsive scenarios. Customer destinations now form confidence/decision journeys; Crew Lead Route/Jobs/Recovery and Crew Member Work/read-only Route/personal Saved destinations now preserve their distinct field authority. Deepen operations next; conduct human review before bounded production adoption. |
