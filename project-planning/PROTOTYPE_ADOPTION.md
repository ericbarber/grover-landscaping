...
Use the [`design artifact inventory`](../design/ARTIFACT_STATUS.md) to determine
whether a specific prototype or image is a dated mirror, adopted behavior,
design direction, historical input, or product-gated boundary.
...
| --- | --- | --- | --- |
| Modern website and app preview | [Working concept](../design/prototypes/modern-grover/README.md), [persona profiles](../design/personas/README.md), [prototype plan](../design/review/modern-website-prototype-plan.md), and [comparison guide](../design/review/modern-website-comparison-guide.md) | Design direction; no React adoption | Compare the public/customer/provider paths and five role previews with the current app and simplified service thread in participant sessions. Confirm messaging, tasks, and role boundaries before creating bounded production slices. |
| Simplified product experience | [Active service-thread prototype](../design/prototypes/simplified-service-thread/README.md), [post-MVP plan](../design/review/simplified-product-experience-plan.md), [SX4 comparative study](../design/review/simplified-product-experience-comparative-study.md), and [retained research kit](../design/review/minimal-product-workflow-session-guide.md) | SX4 study package ready; shared component groundwork only | Five core perspectives and seven contextual paths are validated as responsive design direction. The adopted Yard Owner progress rail is extracted into a typed shared component without adopting the new composition. Conduct the matched comparison, resolve critical findings, and synthesize anonymous evidence before React adoption. |
| Current frontend parity | [Dated responsive mirror](../design/prototypes/current-frontend-review/README.md) and [September 3 audit](../design/review/current-frontend-design-audit-2026-09-03.md) | Dated current mirror | Eight representative surfaces preserve the September 3 baseline. Manager Home urgency, shell compression, and truth/recovery were delivered afterward and are intentionally tracked as post-mirror changes. |
| Frontend truth and recovery | [Working state prototype](../design/prototypes/frontend-truth-recovery/README.md) and [design contract](../design/review/frontend-truth-recovery-design.md) | Adopted | Five Yard Owner protected-read outcomes map to typed API results with fail-closed loading/error behavior, retry or access review, and Home recovery. Crew Route uses local-day date context and bounded persistence-confidence language while preserving durable offline replay/conflict handling. |
| All-persona minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md), [all-persona plan](../design/review/all-persona-minimal-rollout-plan.md), [owner plan](../design/review/yard-owner-minimal-rollout-plan.md), and [crew plan](../design/review/crew-lead-minimal-rollout-plan.md) | Adopted repository behavior; hosted evidence pending | Thirty-six cumulative units cover all ten signed-in persona designs. Exact-scope cohorts, immutable lifecycle audit, guarded owner/support operations, cumulative navigation and persona composition, manager continuity, shell clearance, and the protected per-unit runner are delivered for authoritative roles. Hosted execution, operational enablement, and explicit Dispatcher/Billing backend roles remain. |
...
| Shared visual foundation | [Consistency review](../design/review/cross-prototype-visual-consistency-review.md) | Adopted core / incremental migration | The production authenticated shell uses one outlined SVG icon family, phone bottom bar, tablet rail, persistent desktop rail, single-destination desktop composition, shared semantic notices/status pills, consolidated hosted account controls, and measured fixed-navigation clearance. Migrate legacy panel feedback only during its owning workflow phase. |
...
| Yard Owner portal | [Working portal](../design/prototypes/yard-owner-portal/README.md) and [V2 handoff](../design/review/yard-owner-portal-v2-handoff.md) | Partial · service-day and recommendation core adopted | Home, Visits, Proof, and Account plus property context, delivered proof, all six explicit service-day modes, and current/historical recommendation decisions are adopted. Home/Visits use minimized authorized persisted reads with explicit recovery and no illustrative fallback. Remaining: concern recovery, notification/access preferences, and provider contact. Billing remains product-gated. |
...
## Production-adoption sequence record
...
5. Property-manager command-center core is adopted. The hybrid Yard
...
delivered. The minimized visit read and its Yard Owner interface adoption are
also delivered. The customer-safe service-day lifecycle extension is delivered
...
Future adoption phases may be split into smaller implementation commits. A phase is not complete
