...
| Yard Crew acquisition | [Working provider journey](../design/prototypes/yard-crew-acquisition/README.md), [handoff](../design/review/yard-crew-acquisition-handoff.md), and [entry/readiness contract](../docs/provider-entry-routing.md) | Public fit/entry adopted · identity/readiness core partial | Current organization/profile/setup reads now distinguish supplied, recorded, operational, missing, not-collected, and not-evaluated facts. Next reconcile the already delivered known-owner assessment/proposal/first-visit loop, then identify only safe ungated provider gaps. Curated opportunities and alerts remain gated. |
...
5. Property-manager command-center core is adopted. Yard Owner persisted visit
   ...
   decision.
6. **Active:** reconcile the already delivered Yard Crew known-owner connection,
   assessment, proposal, activation, and first-visit loop against the prototype;
   do not promote curated opportunity discovery past its gates.
