...
| --- | --- | --- | --- |
| Simplified product experience | [Active service-thread prototype](../design/prototypes/simplified-service-thread/README.md), [post-MVP plan](../design/review/simplified-product-experience-plan.md), and [retained research kit](../design/review/minimal-product-workflow-session-guide.md) | SX2 validated design direction; production adoption not started | Yard Owner, Property Manager, Company Owner, Company Manager, and Crew Lead now follow one exact service through decision, release, field work/recovery, and proof with role-filtered content. Add contextual exception paths next; retain other persona work as broader evidence and begin production adoption only after comparative workflow review. |
