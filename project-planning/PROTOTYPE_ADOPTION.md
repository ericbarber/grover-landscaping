...
| All-persona minimal rollout | [Functional-unit prototype](../design/prototypes/yard-owner-minimal-rollout/README.md), [all-persona plan](../design/review/all-persona-minimal-rollout-plan.md), [owner plan](../design/review/yard-owner-minimal-rollout-plan.md), and [crew plan](../design/review/crew-lead-minimal-rollout-plan.md) | Partial; projection and cohort persistence delivered | Thirty-six cumulative units cover all ten signed-in persona designs. `/me/access` now applies exact-scope active enrollments over default-off maps; migration 123 constrains cumulative units and preserves immutable lifecycle audit. Guarded operator APIs, navigation shaping, protected smoke, and explicit Dispatcher/Billing backend roles remain before live enablement. |
