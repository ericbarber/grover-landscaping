...
| Yard Crew acquisition | [Working provider journey](../design/prototypes/yard-crew-acquisition/README.md), [handoff](../design/review/yard-crew-acquisition-handoff.md), and [entry route](../docs/provider-entry-routing.md) | Public fit/entry adopted · identity/readiness partial | Continue precise provider organization/profile/readiness adoption, then connect known-owner assessment, proposal, and first-service preparation. Curated opportunities and alerts remain gated on marketplace operations. |
...
5. Property-manager command-center core is adopted. Yard Owner persisted visit
   ...
   decision.
6. **Active:** continue Yard Crew provider identity/readiness after public fit and
   entry routing; do not promote curated opportunity discovery past its gates.
