...
| --- | --- | --- | --- |
| Modern website and app preview | [Prior working concept](../design/prototypes/modern-grover/README.md), [persona hypotheses](../design/personas/README.md), and the independent [Modern Grover workplan](../modern-grover/WORKPLAN.md) | Prior candidate; no React adoption | The new track first reconciles public claims, audience entry, and cross-role task flow. Compare matched tasks with earlier candidates and the current app before proposing bounded production slices. |
