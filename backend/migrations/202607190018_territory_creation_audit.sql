...
ALTER TABLE access_audit_events
    ...
    CHECK (
        event_kind IN (
            ...
            'branch_created', 'territory_created', 'invite_accepted',
            'invitation_revoked', 'invitation_reissued', 'role_changed',
            'membership_profile_updated', 'membership_suspended',
            'membership_reactivated', 'account_viewed', 'portfolio_changed',
            'crew_assignment_changed', 'crew_profile_updated', 'crew_deactivated',
