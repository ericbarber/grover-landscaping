...
describe('manager day plan helpers', () => {
  ...
  it('keeps a valid selected crew and otherwise selects the first tenant crew', () => {
    const crews = [
      { id: 'crew_1', name: 'North', organizationId: 'org_1', status: 'active' as const, dailyStopCapacity: 10, leadMembershipId: null, persisted: true },
      { id: 'crew_2', name: 'South', organizationId: 'org_1', status: 'active' as const, dailyStopCapacity: 10, leadMembershipId: null, persisted: true },
    ];
