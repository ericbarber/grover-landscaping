...
describe('core API client mapping', () => {
  ...
  it('builds and maps organization invitations', () => {
    ...
    expect(toOrganizationInvitationSummary({
      ...
      membership_id: 'membership_1',
      expires_at: null,
      delivery_notification_id: 'notification_1',
  ...
  it('builds organization membership administration paths', () => {
    ...
    expect(toTeamAdministrationActivity({
      ...
      destination_branch_id: 'branch_south',
      destination_territory_id: 'territory_tempe',
      ...
      destinationBranchId: 'branch_south',
      destinationTerritoryId: 'territory_tempe',
