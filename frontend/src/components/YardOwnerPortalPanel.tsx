  ...
  if (visitReadError) {
    const copy = visitReadError === 'access_required'
      ? {
        ...
        detail: 'Property and service details remain hidden until the current access connected to this sign-in can be confirmed.',
        retryLabel: 'Check account access again',
      }
