  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6" id="marketing-lead-inbox">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div><p className="text-xs font-black uppercase tracking-[0.16em] text-emerald-700">Platform operations</p><h2 className="mt-1 text-2xl font-black">Marketing lead inbox</h2><p className="mt-1 text-sm text-slate-500">Support-admin access only · {leads.filter((lead) => lead.status === 'new').length} new · {leads.filter(isOverdue).length} overdue</p></div>
