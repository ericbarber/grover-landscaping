    ...
    <main className="min-h-screen bg-bone text-slate-950">
      ...
      <div className="mx-auto grid max-w-4xl gap-5 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_18rem]">
        <section className="grover-card p-5 sm:p-8" aria-labelledby="provider-progress-title">
          ...
          {progress ? (
            <article className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5" aria-live="polite" id="provider-invitation-status">
          ...
          {progress ? <ProviderConnectionJourney disclosure={disclosure} firstVisit={firstVisit} progress={progress} /> : null}
          ...
          {disclosure ? (
            <section className="mt-6 rounded-2xl border border-sky-200 bg-sky-50 p-5" aria-labelledby="provider-assessment-title" id="provider-assessment-access">
