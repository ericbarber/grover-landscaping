...
| [Customer and manager prototype](prototype/README.md) | First M2 decision handoff, with simulated release and recovery | Interactive concept; no real write or participant result |
