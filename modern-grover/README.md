...
| [Customer, manager, and field prototype](prototype/README.md) | M2 decision and field handoffs, with simulated offline and recovery | Interactive concept; no real write or participant result |
