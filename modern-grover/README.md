...
| [Manager service prototype](prototype/README.md) | First new M2 decision slice, with simulated release and recovery | Interactive concept; no real write or participant result |
