...
| [Local study environment](fixtures/LOCAL_STUDY_ENV.md) | Separate database, API, and migration baseline | Study API prepared on this host; no matched fixture or reset |
