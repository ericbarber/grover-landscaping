# Yard Crew Acquisition and Opportunity Design Plan
...
background checks, insurance verification, lead fees, rankings, or production
matching.

## Current delivery status

| Phase | Status | Review outcome |
| --- | --- | --- |
| 0. Product audit | Complete | Existing field, provider, owner-acquisition, privacy, and marketplace boundaries mapped |
| 1. Journey and trust model | Complete | Provider-organization model, three entry paths, opportunity lifecycle, assessment boundary, and support model defined |
...
### “Yard Crew” is an audience, not a public account type
...
This distinction lets the marketing experience speak naturally to working crews
without exposing employees as owner-selectable marketplace inventory. Yard
owners continue to choose provider organizations. The provider remains
responsible for crew continuity, assignments, supervision, pricing, safety, and
service delivery.
...
- Join the field workspace without being pushed through company acquisition.
- Recover an expired, revoked, wrong-recipient, or already-used invitation.
...
- **Set up my provider profile** for owner-operators and company owners.
- **Join my crew** for invited workers.
- **See how opportunities work** as a non-committing explanation.

Marketing proof should use supported product capabilities—scope, scheduling,
field evidence, customer communication, offline work, and audit history—rather
than testimonials, earnings, lead volume, or unverified growth claims.
...
For owner-operators and company owners:

- verify email and mobile contact;
- create or claim the legal/trade business identity;
- choose the customer-facing display name;
- attest authority to represent the provider;
- review possible duplicate organizations before creating another;
- identify the responsible owner/administrator.

For invited workers:

- verify the invited destination;
- inspect provider name, inviter, offered role, scope, and expiration;
- accept, decline, report an unexpected invitation, or request a corrected one.

Account creation does not make a provider searchable or eligible for requests.

### Stage 3 — Service profile and territory
...
- preferred assessment method and typical response window;
- languages and accessible contact options;
- days/hours accepting new requests;
- temporary pause without profile deletion.
...
It must not show exact address, owner contact, access instructions, photographs,
competitors, ranking position, estimated owner budget, or guaranteed job value.
...
- an assessment summary that the owner can review;
- a clear stop when the provider cannot safely or credibly price the work.
...
- assessed scope and exclusions;
- one-time restoration versus recurring work;
- cadence and service-window policy;
...
Support is part of the acquisition journey, not a footer link added later.

### Setup support

- Save and resume with a clear last-completed step.
- Plain-language examples for services and territory.
- Duplicate-business recovery and organization-claim escalation.
- Invitation resend, wrong-recipient, expiry, and role-correction paths.
- Verification status, missing requirement, document expiry, correction, and
  appeal guidance.
- Language and accessibility preferences.

### Opportunity support

- Explain why a request was shown without revealing ranking or competitors.
- Decline without requiring sensitive internal reasons or implying punishment.
- Pause requests by service, area, or time period.
- Report spam, unsafe requests, discrimination, harassment, or suspicious
  contact attempts.
- Block future contact where policy allows.
- Preserve an auditable disclosure receipt and withdrawal status.

### Assessment and service support

- Safety stop and emergency guidance separate from ordinary support.
- Customer-safe reschedule, access-blocked, weather, and scope-change workflows.
- Proposal correction/revision without overwriting accepted history.
- Incident and dispute intake with evidence-preservation guidance.
- Offline and synchronization recovery for field work after activation.

### Account and data support

- Role/access review, team removal, ownership transfer, and account recovery.
- Profile pause, correction, export, retention, and deletion eligibility.
- Notification destinations, quiet hours, and response coverage.
- Clear paths for ending an owner relationship without erasing required service
  history.

## State model required in the working prototype
...
- Declines, pauses, and no-result states must be neutral and recoverable.

## Prototype review sequence

The first working prototype should let a reviewer:
...
support decisions before production implementation:

- provider eligibility by region and service;
- business identity and organization-claim authority;
- insurance/license/certification source, freshness, expiry, correction, and
  appeal policy;
- background checks or worker screening, if any;
- opportunity allocation, rate limits, response windows, density, and fairness;
- discrimination, harassment, abuse, blocking, and incident operations;
- lead fees, subscriptions, payments, deposits, payouts, refunds, taxes, or
  worker classification;
- ratings, reviews, ranking, sponsorship, exclusivity, or performance claims;
- owner/provider cancellation, dispute, evidence, and retention rules;
- supported regions, languages, accessibility assistance, and support hours.
