...
| 5. Customers and portfolios | In progress · Yard Owner persisted Home/Visits and property-manager core adopted | Extend the authorized visit boundary into customer-safe service-day states, then continue concern and preference states; separately authorize property-manager readiness; keep billing gated |
