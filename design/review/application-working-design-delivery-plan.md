...
| 5. Customers and portfolios | In progress · Yard Owner persisted Home/Visits and property-manager core adopted | Implement the accepted mobilization/work-release source before service-day states, then continue concern and preference states; separately authorize property-manager readiness; keep billing gated |
