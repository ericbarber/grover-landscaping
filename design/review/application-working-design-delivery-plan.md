...
| 5. Customers and portfolios | In progress · Yard Owner persisted Home/Visits and property-manager core adopted | Accept the mobilization/work-release source decision before service-day states, then continue concern and preference states; separately authorize property-manager readiness; keep billing gated |
