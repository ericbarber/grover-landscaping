...
| 5. Customers and portfolios | In progress · Yard Owner persisted Home/Visits, mobilization persistence, and property-manager core adopted | Expose provider release/status APIs and extend the hybrid customer projection before service-day UI states, then continue concern and preference states; separately authorize property-manager readiness; keep billing gated |
