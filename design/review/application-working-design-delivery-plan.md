...
| 5. Customers and portfolios | In progress · Yard Owner shell/Home and property-manager core adopted | After the authorization decision, persist customer visit reads and continue Yard Owner service-day, concern, and preference states; replace property-manager illustrative readiness from the same authorized source; keep billing gated |
