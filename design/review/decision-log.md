...
| D-060 | Customer visit communication | Deliver visit questions through a dedicated immutable customer/provider thread identified by a random non-bearer customer visit reference and hybrid authorization; use an organization-owner/manager provider queue, make no notification/SLA claim, and keep post-service concerns as a separately approved evented workflow. | Proposed | 2026-08-26 | Product/operations/security |
