(() => {
  ...
  function requestView() {
    ...
    const pending = state.interest === 'pending' ? `<div class="stage-note warning"><span aria-hidden="true">…</span><div><strong>Waiting for the owner</strong>Morgan can share each detail separately, ask a question, choose another provider, or let the request expire.</div></div><div class="stage-actions"><button class="button button-primary" type="button" data-owner-approve>Review sharing status</button><button class="button button-secondary" type="button" data-withdraw-interest>Withdraw request</button></div>` : '';
